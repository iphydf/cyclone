...
namespace Formatstr {
  ...
  List::list_t<Absyn::type_t> get_format_types(Tcenv::tenv_t, string_t, bool isCproto,
                                               Position::seg_t);

  // Same as above, but the rules and types are different for scanf
  List::list_t<Absyn::type_t> get_scanf_types(Tcenv::tenv_t, string_t, bool isCproto,
                                              Position::seg_t);
}  // namespace Formatstr
