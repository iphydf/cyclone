...
namespace Tcutil {
  ...
  list_t<$(type_t, type_t) @> rsubst_type_assoc(region_t<`r>, list_t<$(tvar_t, type_t) @`r,`r>,
                                                list_t<$(type_t, type_t) @`H,`H>);
  list_t<effconstr_t> rsubst_effconstr(region_t<`r> rgn, list_t<$(tvar_t, type_t) @`r,`r> inst,
  ...
  bool check_eff_in_cap(seg_t loc, bool may_constrain_evars, type_t eff,
                        list_t<effconstr_t,`H> equality_constraints, type_t cap);
  bool satisfies_effect_constraints(seg_t loc, list_t<effconstr_t> ec,
  ...
  list_t<$(aggrfield_t,`a) @`r,`r> resolve_aggregate_designators(
      region_t<`r>, seg_t, list_t<$(list_t<designator_t,`H>,`a) @`r2,`r3>, aggr_kind_t,
      list_t<aggrfield_t>);
