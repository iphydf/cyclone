...
namespace Vcgen {
  ...
  extern void vcgen_fundecl(Position::seg_t loc, JumpAnalysis::jump_anal_res_t tables,
                            Absyn::fndecl_t fd, assn_info_t assn_info,
                            fn_precond_info_t fn_precond_info, bool use_precond);
