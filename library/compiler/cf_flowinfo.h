...
namespace CfFlowInfo {
  ...
  extern aggrdict_t aggrfields_to_aggrdict(flow_env_t, List::list_t<struct Absyn::Aggrfield @>,
                                           bool no_init_bits_only, absRval_t);
  extern absRval_t typ_to_absrval(flow_env_t, Absyn::type_t, bool no_init_bits_only,
                                  absRval_t leafval);
  extern absRval_t make_unique_consumed(flow_env_t, Absyn::aqualbnds_t, Absyn::type_t,
                                        Absyn::exp_t consumer, int iteration, absRval_t, bool);
...
#define DEBUG_PRINT(arg...) \
  ...
  extern flowdict_t assign_place(flow_env_t, Position::seg_t, flowdict_t, place_t, absRval_t);
  extern flow_t join_tryflow(flow_env_t, flow_t, flow_t);
  extern flow_t join_flow(flow_env_t, flow_t, flow_t);
  extern $(flow_t, absRval_t)
      join_flow_and_rval(flow_env_t, $(flow_t, absRval_t), $(flow_t, absRval_t));
