...
void *Cyc_Core_get_exn_thrown() { return _exn_thrown; }

const char *Cyc_Core_get_exn_filename() { return _exn_filename; }
int Cyc_Core_get_exn_lineno() { return _exn_lineno; }
