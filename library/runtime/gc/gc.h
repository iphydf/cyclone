 ...
 */
GC_INLINE void *GC_hide(void *ptr) { return (void *)(~((uintptr_t)ptr)); }
GC_INLINE void *GC_unhide(void *ptr) { return (void *)(~((uintptr_t)ptr)); }
...
GC_INLINE size_t GC_index_unit(size_t idx) {
  return (idx > GC_BIG_IDX_OFFSET ? (idx > GC_HUGE_IDX_OFFSET ? GC_HUGE_UNIT : GC_BIG_UNIT)
                                  : GC_UNIT);
}
GC_INLINE size_t GC_index(void *ptr);
GC_INLINE size_t GC_unit(void *ptr) { return GC_index_unit(GC_index(ptr)); }
GC_INLINE size_t GC_size_unit(size_t size) {
  return (size > GC_BIG_UNIT ? (size > GC_HUGE_UNIT ? GC_HUGE_UNIT : GC_BIG_UNIT) : GC_UNIT);
}
 ...
 */
GC_INLINE void *GC_region(void *ptr) { return GC_MEMORY + gc_index(ptr) * GC_REGION_SIZE; }
GC_INLINE void *GC_index_region(size_t idx) { return GC_MEMORY + idx * GC_REGION_SIZE; }
 ...
 * Object sizes.
 */
GC_INLINE size_t GC_size(void *ptr) { return __gc_regions[GC_index(ptr)].size; }
GC_INLINE size_t GC_index_size(size_t idx) { return __gc_regions[(idx)].size; }
 ...
 * GC tagged pointers.
 */
GC_INLINE void *GC_settag(void *ptr, uint32_t tag) { return (char *)ptr + tag; }
GC_INLINE uint32_t GC_gettag(void *ptr) { return ((uint32_t)(uintptr_t)ptr) & (GC_ALIGNMENT - 1); }
GC_INLINE void *GC_deltag(void *ptr, uint32_t tag) { return (char *)ptr - tag; }
GC_INLINE void *GC_striptag(void *ptr) { return (char *)ptr - GC_gettag(ptr); }
 ...
 */
GC_INLINE void *GC_setextag(void *ptr, uint32_t tag) { return (char *)ptr + tag; }
GC_INLINE void *GC_base(void *ptr);
GC_INLINE uint32_t GC_getextag(void *ptr) { return (uint32_t)((char *)ptr - (char *)GC_base(ptr)); }
GC_INLINE void *GC_delextag(void *ptr, uint32_t tag) { return (char *)ptr - tag; }
GC_INLINE void *GC_stripextag(void *ptr) { return GC_base(ptr); }
...
extern void *GC_malloc(size_t size) __attribute__((__malloc__));
