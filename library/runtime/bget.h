...
struct bget_region_key {
  ...
  __attribute__((aligned)) void *priv;
};
...
void bectl _((bget_rgn_key_t, int (*compact)(bget_rgn_key_t, bufsize sizereq, int sequence),
              void *(*acquire)(void *, bufsize size, bufsize *incr),
              void (*release)(bget_rgn_key_t, void *buf), bufsize pool_incr));
void bstats _((bget_rgn_key_t, bufsize *curalloc, bufsize *totfree, bufsize *maxfree, long *nget,
               long *nrel));
void bstatse _((bget_rgn_key_t, bufsize *pool_incr, long *npool, long *npget, long *nprel,
