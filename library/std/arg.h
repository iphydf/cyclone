...
namespace Arg {
  ...
  /** The [speclist] elements are, in order:
      ...
      [isprefix] indicates [flag] matches flags having it as a prefix (i.e. if [flag] is [-x], then
     it will match [-xo -xi -xop] etc.) [argdesc] a description of the argument to the option (if
     any) [spec] the argument spec denoted by the flag [desc] a description of the function of the
     option
  */
