...
namespace Fn {
  ...
  extern struct Function<`arg,`res,`bd> {
    <`env> : regions(`env) <= `bd
  `res(@`H f)(`env,`arg);
    `env env;
  };
  ...
  extern fn_t<`a,`c, `bd2> compose(fn_t<`a,`b,`bd> g, fn_t<`b,`c,`bd> f
                                   : regions($(`a,`b,`c) @`H +`bd) <= `bd2);
  /** [compose(g,f)] returns the composition of closures [f] and [g];
      [apply(compose(g,f),x)] has the same effect as
      [apply(f,apply(g,x))]. */

  extern fn_t<`a, fn_t<`b,`c,`bd2>, `bd2> curry(fn_t<$(`a,`b) @`H,`c,`bd> f
                                                : regions($(`a,`b,`c) @`H +`bd) <= `bd2);
  ...
  extern fn_t<$(`a,`b) @,`c,`bd3> uncurry(fn_t<`a, fn_t<`b,`c,`bd2>,`bd> f
                                          : regions($(`a,`b,`c) @`H +`bd +`bd2) <= `bd3);
