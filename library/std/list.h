...
#include "core.h"
  ...
  namespace List {
    ...
    /** If [x] has elements [x1] through [xn], and [y] has elements [y1]
        ...
        thrown. */
    extern list_t<`c,`r> rmap2(region_t<`r>,`c f(`a,`b), list_t<`a> x, list_t<`b> y);
    /** [rmap2(r,f,x,y)] is like [map2(f,x,y)], except that the
        resulting list is allocated in the region with handle [r]. */
    extern list_t<`d> map3(`d f(`a,`b,`c), list_t<`a> x, list_t<`b> y, list_t<`c> z);
    /** If [x] has elements [x1] through [xn], [y] has elements [y1]
        ...
        thrown. */
    extern list_t<`d,`r> rmap3(region_t<`r>,`d f(`a,`b,`c), list_t<`a> x, list_t<`b> y,
                               list_t<`c> z);
    ...
    extern list_t<`a,`r> rmerge_sort(region_t<`r>, int cmp(`a,`a), list_t<`a> x);
    ...
    extern list_t<`a,`r3> rmerge(region_t<`r3>, int cmp(`a,`a), list_t<`a> a, list_t<`a> b);
    /** [rmerge(r,cmp,x,y)] is like [merge(cmp,x,y)], except that [x],
        [y], and the result are allocated in the region with handle [r].  */
    extern list_t<`a,`r> imp_merge(int cmp(`a,`a), list_t<`a,`r> a, list_t<`a,`r> b);
    ...
    /** If [x] has elements [x1] through [xn], and [y] has elements [y1]
        ...
        [y] don't have the same number of elements, [List_mismatch] is
        thrown. */
    extern list_t<$(`a,`b) @`r2,`r1> rzip(region_t<`r1> r1, region_t<`r2> r2, list_t<`a> x,
                                          list_t<`b> y);
    ...
    /** If [x] has elements [x1] through [xn], and [y] has elements [y1]
        ...
        [y] don't have the same number of elements, [List_mismatch] is
        thrown. */
    extern list_t<$(`a,`b,`c) @`r2,`r1> rzip3(region_t<`r1> r1, region_t<`r2> r2, list_t<`a> x,
                                              list_t<`b> y, list_t<`c> z);
    ...
    extern $(list_t<`a,`r1>, list_t<`b,`r2>)
        rsplit(region_t<`r1> r1, region_t<`r2> r2, list_t<$(`a,`b) @> x);
    ...
    extern $(list_t<`a,`r3>, list_t<`b,`r4>, list_t<`c,`r5>)
        rsplit3(region_t<`r3> r3, region_t<`r4> r4, region_t<`r5> r5, list_t<$(`a,`b,`c) @> x);
