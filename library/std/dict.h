...
namespace Dict {
  ...
  extern dict_t<`a,`b,`r> inserts(dict_t<`a,`b,`r> d, list_t<$(`a,`b) @> l);
  ...
  extern dict_t<`a,`b,`r> rsingleton(region_t<`r>, int(@`H cmp)(`a,`a),`a k,`b v) @throws(false);
  ...
  /** For every key [k] in the domain of both [d1] and [d2],
      ...
      thrown. */
  extern void iter2_c(void(@f)(`c,`b,`b), `c env, dict_t<`a,`b> d1, dict_t<`a,`b> d2);
  /** [iter2_c] is like [iter] except that [f] takes a closure as its
      first argument. */
  extern `c fold2_c(`c(@f)(`d,`a,`b1,`b2,`c), `d env, dict_t<`a,`b1> d1,
  ...
  /** [map_c(f,env,d)] is like [map(f,d)] except that [f] takes
      [env] as its first argument. */
  extern dict_t<`a,`c,`r> rmap_c(region_t<`r>, `c f(`d,`b),`d env, dict_t<`a,`b> d);
  /** [rmap_c(r,f,env,d)] is like [map_c(f,env,d)] except that the
      resulting dictionary is allocated in the region with handle
      [r]. */

  extern dict_t<`a,`b,`r> union_two_c(`b(@f)(`c,`a,`b,`b), `c env, dict_t<`a,`b,`r> d1,
                                      dict_t<`a,`b,`r> d2);
  ...
  extern dict_t<`a,`b,`r> intersect(`b(@f)(`a,`b,`b), dict_t<`a,`b,`r> d1, dict_t<`a,`b,`r> d2);
  ...
  extern dict_t<`a,`b,`r> intersect_c(`b(@f)(`c,`a,`b,`b), `c env, dict_t<`a,`b,`r> d1,
                                      dict_t<`a,`b,`r> d2);
  ...
  /** [forall_c(f,env,d)] returns true if [f(env,k,v)] returns true for
      ...
      otherwise. */
  extern bool forall_intersect(bool f(`a,`b,`b), dict_t<`a,`b> d1, dict_t<`a,`b> d2);
  ...
  extern dict_t<`a,`b,`r> rfilter_c(region_t<`r>, bool f(`c,`a,`b), `c env, dict_t<`a,`b> d);
  ...
  /** [difference(d1,d2)] returns a dictionary that has a binding of [k]
      ...
      the heap. */
  extern dict_t<`a,`b,`r> rdifference(region_t<`r>, dict_t<`a,`b> d1, dict_t<`a,`b> d2);
