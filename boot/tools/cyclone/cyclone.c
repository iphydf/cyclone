...
static struct Cyc___cycFILE * Cyc_try_file_open(struct _fat_ptr filename,
  ...
  { int _T9 = 0;
    ...
    _T9 = 1;
    goto _TL7;
    _TL6: _TL7: if (_T9) { goto _TL8;
    }else { goto _TLA;
    }
    _TLA: { struct Cyc___cycFILE * _TA = Cyc_file_open(filename,mode);
      _npop_handler(0);
      return _TA;
    }_pop_handler();
    goto _TL9;
    _TL8: _T2 = Cyc_Core_get_exn_thrown();
    { void * _TA = (void *)_T2;
...
static void * Cyc_do_stage(struct _fat_ptr stage_name,struct Cyc_List_List * tds,
  ...
  { struct Cyc_timeval start;
	...
	{ int _T2C = 0;
	  ...
	  _T2C = 1;
	  goto _TLE;
	  _TLD: _TLE: if (_T2C) { goto _TLF;
	  }else { goto _TL11;
	  }
	  _TL11: ans = f(env,tds);
	  _pop_handler();
	  goto _TL10;
	  _TLF: _T8 = Cyc_Core_get_exn_thrown();
	  { void * _T2D = (void *)_T8;
	    void * _T2E;
	    _T2E = _T2D;
	    { void * x = _T2E;
      ...
      Cyc_compile_failure = 1;
      goto _TL15;
      _TL14: _TL15: _T10 = Cyc_compile_failure;
      if (! _T10) { goto _TL16;
      }
      _T11 = Cyc_stderr;
      _T12 = _tag_fat("\nCOMPILATION FAILED!\n",sizeof(char),22U);
	...
	Cyc_fprintf(_T16,_T17,_T18);
      ...
      _T1F = end;
      _T20 = _T1F.tv_usec;
      if (_T20 >= 0) { goto _TL1A;
      }
      end.tv_usec = end.tv_usec + 1000000;
      end.tv_sec = end.tv_sec + -1;
      goto _TL1B;
      _TL1A: _TL1B: { struct Cyc_Int_pa_PrintArg_struct _T2B;
	_T2B.tag = 1;
	_T22 = end;
	_T23 = _T22.tv_sec;
...
static struct Cyc_List_List * Cyc_do_parse(struct Cyc___cycFILE * f,struct Cyc_List_List * ignore) {
  ...
  { struct Cyc_List_List * ans = 0;
	...
	_T8 = 1;
	goto _TL1D;
	_TL1C: _TL1D: if (_T8) { goto _TL1E;
	}else { goto _TL20;
	}
	_TL20: ans = Cyc_Parse_parse_file(f);
	Cyc_file_close(f);
	_pop_handler();
	goto _TL1F;
	_TL1E: _T2 = Cyc_Core_get_exn_thrown();
	{ void * _T9 = (void *)_T2;
	  void * _TA;
	  _T3 = (struct Cyc_Parse_Exit_exn_struct *)_T9;
	  _T4 = _T3->tag;
	  _T5 = Cyc_Parse_Exit;
	  if (_T4 != _T5) { goto _TL21;
	  }
	  Cyc_file_close(f);
	  Cyc_compile_failure = 1;
	  goto _LL0;
...
static struct Cyc_List_List * Cyc_do_typecheck(struct Cyc_Tcenv_Tenv * te,
  ...
  _TL25: tds = Cyc_Tc_treeshake(te,tds);
  goto _TL24;
  _TL23: _TL24: _T1 = tds;
  return _T1;
}
...
static struct Cyc_List_List * Cyc_do_lowtreeshake(long ignore,struct Cyc_List_List * tds) {
  ...
  _TL28: _T1 = Cyc_LowTreeShake_shake(tds);
  return _T1;
  _TL26: _T2 = tds;
  return _T2;
}
static struct Cyc_List_List * Cyc_do_print(struct Cyc___cycFILE * out_file,
  ...
  goto _TL2A;
  _TL29: _T0 = Cyc_Absynpp_c_params_r;
  _TL2A: { struct Cyc_Absynpp_Params params_r = _T0;
...
struct Cyc_List_List * Cyc_Cyclone_parse_file(struct _fat_ptr filename) {
  ...
  { struct Cyc___cycFILE * in_file = Cyc_try_file_open(_T2,_T3,_T4);
    ...
    _TL33: _T6 = Cyc_Flags_stop_after_pass;
    _T7 = (int)_T6;
    if (_T7 < 1) { goto _TL31;
    }
...
static void Cyc_process_file(struct _fat_ptr filename) {
  ...
  _TL36: _T1 = Cyc_Flags_porting_c_code;
  if (! _T1) { goto _TL34;
  }
  Cyc_Port_port(tds);
  return;
  _TL34: _T2 = Cyc_compile_failure;
  if (_T2) { goto _TL37;
  }else { goto _TL39;
  }
  _TL39: _T3 = Cyc_Flags_stop_after_pass;
  _T4 = (int)_T3;
  if (_T4 < 2) { goto _TL37;
  }
  ...
  goto _TL38;
  _TL37: _TL38: _T8 = Cyc_compile_failure;
  if (_T8) { goto _TL3A;
  }else { goto _TL3C;
  }
  _TL3C: _T9 = Cyc_Flags_stop_after_pass;
  _TA = (int)_T9;
  if (_TA < 3) { goto _TL3A;
  }
  { long (* _T85)(struct _fat_ptr,struct Cyc_List_List *,long (*)(long,struct Cyc_List_List *),
  ...
  goto _TL3B;
  _TL3A: _TL3B: { struct Cyc_Tcenv_Tenv * te = Cyc_Tcenv_tc_init();
    _TE = Cyc_compile_failure;
    if (_TE) { goto _TL3D;
    }else { goto _TL3F;
    }
    _TL3F: _TF = Cyc_Flags_stop_after_pass;
    _T10 = (int)_TF;
    if (_T10 < 4) { goto _TL3D;
    }
    ...
    goto _TL3E;
    _TL3D: _TL3E: { struct Cyc_JumpAnalysis_Jump_Anal_Result * jump_tables = 0;
      _T16 = Cyc_compile_failure;
      if (_T16) { goto _TL40;
      }else { goto _TL42;
      }
      _TL42: _T17 = Cyc_Flags_stop_after_pass;
      _T18 = (int)_T17;
      if (_T18 < 5) { goto _TL40;
      }
	...
	_T19 = _T85;
      ...
      goto _TL41;
      _TL40: _TL41: _T1C = Cyc_compile_failure;
      if (_T1C) { goto _TL43;
      }else { goto _TL45;
      }
      _TL45: _T1D = Cyc_Flags_stop_after_pass;
      _T1E = (int)_T1D;
      if (_T1E < 6) { goto _TL43;
      }
      { struct Cyc_List_List * (* _T85)(struct _fat_ptr,struct Cyc_List_List *,
					struct Cyc_List_List * (*)(struct Cyc_JumpAnalysis_Jump_Anal_Result *,
								   struct Cyc_List_List *),
	...
	_T1F = _T85;
      ...
      goto _TL44;
      _TL43: _TL44: _T24 = Cyc_compile_failure;
      if (_T24) { goto _TL46;
      }else { goto _TL48;
      }
      _TL48: _T25 = Cyc_Flags_stop_after_pass;
      _T26 = (int)_T25;
      if (_T26 < 8) { goto _TL46;
      }
	...
	_T27 = _T85;
      ...
      goto _TL47;
      _TL46: _TL47: _T2B = Cyc_compile_failure;
      if (_T2B) { goto _TL49;
      }else { goto _TL4B;
      }
      _TL4B: _T2C = Cyc_Flags_stop_after_pass;
      _T2D = (int)_T2C;
      if (_T2D < 9) { goto _TL49;
      }
      { struct Cyc_List_List * (* _T85)(struct _fat_ptr,struct Cyc_List_List *,
					struct Cyc_List_List * (*)(struct Cyc_Hashtable_Table *,
								   struct Cyc_List_List *),
	...
	_T2E = _T85;
      ...
      goto _TL4A;
      _TL49: _TL4A: _T34 = Cyc_compile_failure;
      if (_T34) { goto _TL4C;
      }else { goto _TL4E;
      }
      _TL4E: _T35 = Cyc_Flags_stop_after_pass;
      _T36 = (int)_T35;
      if (_T36 < 10) { goto _TL4C;
      }
      { struct Cyc_List_List * (* _T85)(struct _fat_ptr,struct Cyc_List_List *,
					struct Cyc_List_List * (*)(long,struct Cyc_List_List *),
	...
	_T37 = _T85;
      ...
      goto _TL4D;
      _TL4C: _TL4D: _T3B = Cyc_compile_failure;
      if (_T3B) { goto _TL4F;
      }else { goto _TL51;
      }
      _TL51: _T3C = Cyc_nolower_r;
      if (_T3C) { goto _TL4F;
      }else { goto _TL52;
      }
      _TL52: _T3D = Cyc_Flags_stop_after_pass;
      _T3E = (int)_T3D;
      if (_T3E < 10) { goto _TL4F;
      }
      { struct Cyc_List_List * (* _T85)(struct _fat_ptr,struct Cyc_List_List *,
					struct Cyc_List_List * (*)(long,struct Cyc_List_List *),
					long,struct Cyc_List_List *) = (struct Cyc_List_List * (*)(struct _fat_ptr,
	...
	_T3F = _T85;
      ...
      goto _TL50;
      _TL4F: _TL50: _T43 = Cyc_compile_failure;
      if (_T43) { goto _TL53;
      }else { goto _TL55;
      }
      _TL55: _T44 = Cyc_Flags_stop_after_pass;
      _T45 = (int)_T44;
      if (_T45 < 11) { goto _TL53;
      }
      { struct Cyc_List_List * (* _T85)(struct _fat_ptr,struct Cyc_List_List *,
					struct Cyc_List_List * (*)(long,struct Cyc_List_List *),
					long,struct Cyc_List_List *) = (struct Cyc_List_List * (*)(struct _fat_ptr,
	...
	_T46 = _T85;
      ...
      goto _TL54;
      _TL53: _TL54: _T4A = Cyc_compile_failure;
      if (_T4A) { goto _TL56;
      }else { goto _TL58;
      }
      _TL58: _T4B = Cyc_Flags_stop_after_pass;
      _T4C = (int)_T4B;
      if (_T4C < 9) { goto _TL56;
      }
      Cyc_Toc_finish();
      goto _TL57;
      _TL56: _TL57: _T4D = Cyc_compile_failure;
      if (_T4D) { goto _TL59;
      }else { goto _TL5B;
      }
      _TL5B: _T4E = Cyc_Flags_stop_after_pass;
      _T4F = (int)_T4E;
      if (_T4F < 14) { goto _TL59;
      }
      { struct Cyc_List_List * (* _T85)(struct _fat_ptr,struct Cyc_List_List *,
					struct Cyc_List_List * (*)(long,struct Cyc_List_List *),
					long,struct Cyc_List_List *) = (struct Cyc_List_List * (*)(struct _fat_ptr,
	...
	_T50 = _T85;
      ...
      goto _TL5A;
      _TL59: _TL5A: _T54 = Cyc_compile_failure;
      if (_T54) { goto _TL5C;
      }else { goto _TL5E;
      }
      _TL5E: _T55 = Cyc_Flags_stop_after_pass;
      _T56 = (int)_T55;
      if (_T56 < 12) { goto _TL5C;
      }
      { struct Cyc_List_List * (* _T85)(struct _fat_ptr,struct Cyc_List_List *,
					struct Cyc_List_List * (*)(long,struct Cyc_List_List *),
					long,struct Cyc_List_List *) = (struct Cyc_List_List * (*)(struct _fat_ptr,
	...
	_T57 = _T85;
      ...
      goto _TL5D;
      _TL5C: _TL5D: _T5B = Cyc_compile_failure;
      if (_T5B) { goto _TL5F;
      }else { goto _TL61;
      }
      _TL61: _T5C = Cyc_Flags_stop_after_pass;
      _T5D = (int)_T5C;
      if (_T5D < 13) { goto _TL5F;
      }
      { struct Cyc_List_List * (* _T85)(struct _fat_ptr,struct Cyc_List_List *,
					struct Cyc_List_List * (*)(long,struct Cyc_List_List *),
					long,struct Cyc_List_List *) = (struct Cyc_List_List * (*)(struct _fat_ptr,
	...
	_T5E = _T85;
      ...
      goto _TL60;
      _TL5F: _TL60: _T62 = Cyc_compile_failure;
      if (_T62) { goto _TL62;
      }else { goto _TL64;
      }
      _TL64: Cyc_Warn_flush_warnings();
      goto _TL63;
      _TL62: _TL63: if (Cyc_uncaught_exn == 0) { goto _TL65;
      }
	...
	{ struct _tuple13 _T89 = *_T85;
      ...
      }_TL65: { struct Cyc___cycFILE * out_file;
	_T72 = Cyc_Flags_stop_after_pass;
	_T73 = (int)_T72;
	if (_T73 > 0) { goto _TL67;
	}
	return;
	_TL67: _T74 = Cyc_Flags_stop_after_pass;
	_T75 = (int)_T74;
	if (_T75 > 6) { goto _TL69;
	}
	...
	_TL6D: return;
	_TL6B: _T7F = Cyc_noprint_r;
	if (_T7F) { goto _TL6F;
	}else { goto _TL71;
	}
	_TL71: { struct Cyc___cycFILE * env = out_file;
	  { struct Cyc_List_List * (* _T85)(struct _fat_ptr,struct Cyc_List_List *,
					    struct Cyc_List_List * (*)(struct Cyc___cycFILE *,
								       struct Cyc_List_List *),
					    struct Cyc___cycFILE *,struct Cyc_List_List *) = (struct Cyc_List_List * (*)(struct _fat_ptr,
...
struct Cyc_List_List * Cyc_global_options[49U] = {(struct Cyc_List_List *)&Cyc_opt1,
...
int Cyc_main(int argc,struct _fat_ptr argv) {
  ...
  { struct _fat_ptr optstring = _tag_fat("Options:",sizeof(char),9U);
    { int i = 1;
      ...
      if (_T1 < 49U) { goto _TL79;
      }else { goto _TL7A;
      }
      _TL79: _T2 = Cyc_global_options;
      _T3 = i - 1;
      _T4 = _T2[_T3];
    ...
    { struct Cyc_List_List * options = _T7[0];
      ...
      if (Cyc_cyclone_files != 0) { goto _TL7C;
      }
      _TB = Cyc_stderr;
      ...
      exit(1);
      goto _TL7D;
      _TL7C: _TL7D: { struct _handler_cons _T1A;
	_TE = &_T1A;
	_push_handler(_TE);
	{ int _T1B = 0;
	  ...
	  _T1B = 1;
	  goto _TL7F;
	  _TL7E: _TL7F: if (_T1B) { goto _TL80;
	  }else { goto _TL82;
	  }
	  _TL82: { struct Cyc_List_List * l = Cyc_List_rev(Cyc_cyclone_files);
	    _TL86: if (l != 0) { goto _TL84;
	    }else { goto _TL85;
	    }
	    _TL84: _T10 = l;
	    _T11 = _T10->hd;
	  ...
	  goto _TL81;
	  _TL80: _T16 = Cyc_Core_get_exn_thrown();
	  { void * _T1C = (void *)_T16;
	    void * _T1D;
	    _T1D = _T1C;
	    { void * x = _T1D;
