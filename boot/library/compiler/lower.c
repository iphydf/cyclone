...
static struct Cyc_Absyn_Exp * Cyc_Lower_lower_rhs(struct Cyc_Lower_Env * env,
  ...
  void * _TC4;
  struct _tuple16 * _TC5;
  struct Cyc_List_List * _TC6;
  struct _tuple16 * _TC7;
  ...
  { void * _T11F = _T6->r;
	...
	case Cyc_Absyn_PostInc: 
	  ...
	  goto _LL5D;
	  _TL52: { struct _tuple14 _T12F = Cyc_Lower_fresh_var(env,e);
	...
	case Cyc_Absyn_PreDec: 
	  ...
	  goto _LL59;
	default: 
	  _LL64: { struct _tuple14 _T12F = Cyc_Lower_fresh_var(env,e);
	    struct Cyc_Absyn_Exp * _T130;
	    struct Cyc_Absyn_Vardecl * _T131;
	    _T131 = _T12F.f0;
	    _T130 = _T12F.f1;
	...
	return _T5B;
	_TL56: { struct _tuple14 _T12F = Cyc_Lower_fresh_var(env,e);
	  struct Cyc_Absyn_Exp * _T130;
	  struct Cyc_Absyn_Vardecl * _T131;
	  _T131 = _T12F.f0;
	  _T130 = _T12F.f1;
	...
	return _T6F;
	_TL58: { struct _tuple14 _T12F = Cyc_Lower_fresh_var(env,e);
	  struct Cyc_Absyn_Exp * _T130;
	  struct Cyc_Absyn_Vardecl * _T131;
	  _T131 = _T12F.f0;
	  _T130 = _T12F.f1;
	...
	return _T83;
	_TL5A: { struct _tuple14 _T12F = Cyc_Lower_fresh_var(env,e);
	  struct Cyc_Absyn_Exp * _T130;
	  struct Cyc_Absyn_Vardecl * _T131;
	  _T131 = _T12F.f0;
	  _T130 = _T12F.f1;
	...
	return _TC0;
	_TL65: { struct _tuple14 _T12F = Cyc_Lower_fresh_var(env,e);
	  struct Cyc_Absyn_Exp * _T130;
	  struct Cyc_Absyn_Vardecl * _T131;
	  _T131 = _T12F.f0;
	  _T130 = _T12F.f1;
	...
	_TL68: _TC3 = dles;
	_TC4 = _TC3->hd;
	_TC5 = (struct _tuple16 *)_TC4;
	{ struct _tuple16 _T12F = *_TC5;
	  struct Cyc_Absyn_Exp * _T130;
	  ...
	  { struct Cyc_List_List * ds = _T131;
	    ...
	    { struct Cyc_List_List * _T132 = _cycalloc(sizeof(struct Cyc_List_List));
	      { struct _tuple16 * _T133 = _cycalloc(sizeof(struct _tuple16));
		_T133->f0 = ds;
		_T133->f1 = v;
		_TC7 = (struct _tuple16 *)_T133;
	      }_T132->hd = _TC7;
	      _T132->tl = dles2;
  ...
  _TL71: { struct _tuple14 _T11F = Cyc_Lower_fresh_var(env,e);
