...
static void * Cyc_Port_gen_exp(long takeaddress,struct Cyc_Port_Cenv * env,
  ...
  { void * _TFF = _T0->r;
	...
	{ struct _tuple16 _T10A = Cyc_Port_lookup_var(env,x);
	  unsigned int _T10B;
	  struct _tuple14 _T10C;
	  _T10C = _T10A.f0;
	  _T10B = _T10A.f1;
	  { struct _tuple14 p = _T10C;
	...
	struct _tuple14 _T10A = Cyc_Port_gen_lhs(env,e1,0);
	void * _T10B;
	void * _T10C;
	_T10C = _T10A.f0;
	_T10B = _T10A.f1;
	...
	struct _tuple14 _T10A = Cyc_Port_gen_lhs(env,e1,1);
	void * _T10B;
	void * _T10C;
	_T10C = _T10A.f0;
	_T10B = _T10A.f1;
