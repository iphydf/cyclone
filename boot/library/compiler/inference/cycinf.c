...
static struct gen_term atomic_ = {
  ATOMIC_, ATOMIC_
};
ptrbnd atomic (void);
...
stamp
ptrbnd_get_stamp (gen_e arg1)
{
  return term_get_stamp ((gen_e)arg1);
}

bool
ptrbnd_is_var (gen_e arg1)
{
...
ptrbnd
ptrbnd_fresh (const char *name)
{
  return term_fresh (name);
}

ptrbnd
ptrbnd_fresh_small (const char *name)
{
  return term_fresh_small (name);
}

ptrbnd
ptrbnd_fresh_large (const char *name)
{
  return term_fresh_large (name);
}

ptrbnd
ptrbnd_constant (const char *name)
{
  return term_constant (name);
}

bool
ptrbnd_is_constant (ptrbnd e, const char *name)
{
...
void
ptrbnd_inclusion_ind (ptrbnd e1, ptrbnd e2)
{
  term_unify (ptrbnd_con_match, ptrbnd_occurs, e1, e2);
}

bool
ptrbnd_eq (ptrbnd e1, ptrbnd e2)
{
  return term_eq (e1, e2);
}

int
ptrbnd_cmp (const ptrbnd e1, const ptrbnd e2)
{
  return term_get_stamp (e1) - term_get_stamp (e2);
}

void
ptrbnd_inclusion_ind_contra (ptrbnd e1, ptrbnd e2)
{
  term_unify (ptrbnd_con_match, ptrbnd_occurs, e2, e1);
}

void
ptrbnd_unify (ptrbnd e1, ptrbnd e2)
{
  banshee_clock_tick ();
...
void
ptrbnd_cunify (ptrbnd e1, ptrbnd e2)
{
  banshee_clock_tick ();
...
void
ptrbnd_cunify_ind (ptrbnd e1, ptrbnd e2)
{
  term_cunify (ptrbnd_con_match, ptrbnd_occurs, e1, e2);
}

void
ptrbnd_unify_ind (ptrbnd e1, ptrbnd e2)
{
  term_unify (ptrbnd_con_match, ptrbnd_occurs, e1, e2);
}
...
bool
ptrbnd_is_atomic (ptrbnd arg1)
{
  return ((gen_term)arg1)->type == atomic_.st;
}

bool
ptrbnd_is_numelts (ptrbnd e)
{
  return ((gen_term)e)->type == 12;
}

ptrbnd
numelts (intbound arg1)
{
  struct numelts_ *ret;
  stamp s[2];
...
void
ptrbnd_print (FILE *arg1, ptrbnd arg2)
{
...
bool
ptrbnd_occurs (term_var arg1, ptrbnd arg2)
{
  gen_e ecr = term_get_ecr (arg2);
...
void
ptrbnd_con_match (gen_e arg1, gen_e arg2)
{
...
stamp
effect_get_stamp (gen_e arg1)
{
  return setif_get_stamp ((gen_e)arg1);
}

bool
effect_is_var (gen_e arg1)
{
...
effect
effect_fresh (const char *name)
{
  return setif_fresh (name);
}

effect
effect_fresh_small (const char *name)
{
  return setif_fresh_small (name);
}

effect
effect_fresh_large (const char *name)
{
  return setif_fresh_large (name);
}

effect
effect_union (effect_list exprs)
{
  return setif_union (exprs);
}

effect
effect_inter (effect_list exprs)
{
  return setif_inter (exprs);
}

effect
effect_constant (const char *name)
{
  return setif_constant (name);
}

bool
effect_eq (effect e1, effect e2)
{
  return setif_eq (e1, e2);
}

int
effect_cmp (const effect e1, const effect e2)
{
  return setif_get_stamp (e1) - setif_get_stamp (e2);
}

bool
effect_is_constant (effect e, const char *name)
{
...
void
effect_inclusion_ind (effect e1, effect e2)
{
  setif_inclusion (effect_con_match, effect_res_proj, effect_print, e1, e2);
}

void
effect_inclusion (effect e1, effect e2)
{
  banshee_clock_tick ();
...
void
effect_inclusion_ind_contra (effect e1, effect e2)
{
  setif_inclusion (effect_con_match, effect_res_proj, effect_print, e2, e1);
}

void
effect_unify_ind (effect e1, effect e2)
{
  setif_inclusion (effect_con_match, effect_res_proj, effect_print, e1, e2);
  setif_inclusion (effect_con_match, effect_res_proj, effect_print, e2, e1);
}
...
void
effect_unify (effect e1, effect e2)
{
  banshee_clock_tick ();
...
void
effect_print (FILE *arg1, effect arg2)
{
...
bool
effect_res_proj (setif_var arg1, gen_e arg2)
{
  switch (((setif_term)arg2)->type)
    {
    default:
...
void
effect_con_match (gen_e arg1, gen_e arg2)
{
...
stamp
zeroterm_get_stamp (gen_e arg1)
{
  return term_get_stamp ((gen_e)arg1);
}

bool
zeroterm_is_var (gen_e arg1)
{
  return term_is_var ((gen_e)arg1);
}
...
zeroterm
zeroterm_fresh (const char *name)
{
  return term_fresh (name);
}

zeroterm
zeroterm_fresh_small (const char *name)
{
  return term_fresh_small (name);
}

zeroterm
zeroterm_fresh_large (const char *name)
{
  return term_fresh_large (name);
}

zeroterm
zeroterm_constant (const char *name)
{
  return term_constant (name);
}

bool
zeroterm_is_constant (zeroterm e, const char *name)
{
  if (term_is_constant (e))
    return !strcmp (name, term_get_constant_name (e));
  else
...
zeroterm
zeroterm_ecr (zeroterm e)
{
  return term_get_ecr (e);
}

void
zeroterm_inclusion_ind (zeroterm e1, zeroterm e2)
{
  term_unify (zeroterm_con_match, zeroterm_occurs, e1, e2);
}

bool
zeroterm_eq (zeroterm e1, zeroterm e2)
{
  return term_eq (e1, e2);
}

int
zeroterm_cmp (const zeroterm e1, const zeroterm e2)
{
  return term_get_stamp (e1) - term_get_stamp (e2);
}

void
zeroterm_inclusion_ind_contra (zeroterm e1, zeroterm e2)
{
  term_unify (zeroterm_con_match, zeroterm_occurs, e2, e1);
}

void
zeroterm_unify (zeroterm e1, zeroterm e2)
{
  banshee_clock_tick ();
...
void
zeroterm_cunify (zeroterm e1, zeroterm e2)
{
  banshee_clock_tick ();
...
void
zeroterm_cunify_ind (zeroterm e1, zeroterm e2)
{
  term_cunify (zeroterm_con_match, zeroterm_occurs, e1, e2);
}

void
zeroterm_unify_ind (zeroterm e1, zeroterm e2)
{
  term_unify (zeroterm_con_match, zeroterm_occurs, e1, e2);
}

void
zeroterm_print (FILE *arg1, zeroterm arg2)
{
  gen_e ecr = term_get_ecr (arg2);
...
bool
zeroterm_occurs (term_var arg1, zeroterm arg2)
{
  gen_e ecr = term_get_ecr (arg2);
...
void
zeroterm_con_match (gen_e arg1, gen_e arg2)
{
  switch (((gen_term)arg1)->type)
    {
    default:
...
stamp
intlit_get_stamp (gen_e arg1)
{
  return term_get_stamp ((gen_e)arg1);
}

bool
intlit_is_var (gen_e arg1)
{
  return term_is_var ((gen_e)arg1);
}
...
intlit
intlit_fresh (const char *name)
{
  return term_fresh (name);
}

intlit
intlit_fresh_small (const char *name)
{
  return term_fresh_small (name);
}

intlit
intlit_fresh_large (const char *name)
{
  return term_fresh_large (name);
}

intlit
intlit_constant (const char *name)
{
  return term_constant (name);
}

bool
intlit_is_constant (intlit e, const char *name)
{
  if (term_is_constant (e))
    return !strcmp (name, term_get_constant_name (e));
  else
...
void
intlit_inclusion_ind (intlit e1, intlit e2)
{
  term_unify (intlit_con_match, intlit_occurs, e1, e2);
}

bool
intlit_eq (intlit e1, intlit e2)
{
  return term_eq (e1, e2);
}

int
intlit_cmp (const intlit e1, const intlit e2)
{
  return term_get_stamp (e1) - term_get_stamp (e2);
}

void
intlit_inclusion_ind_contra (intlit e1, intlit e2)
{
  term_unify (intlit_con_match, intlit_occurs, e2, e1);
}

void
intlit_unify (intlit e1, intlit e2)
{
  banshee_clock_tick ();
...
void
intlit_cunify (intlit e1, intlit e2)
{
  banshee_clock_tick ();
...
void
intlit_cunify_ind (intlit e1, intlit e2)
{
  term_cunify (intlit_con_match, intlit_occurs, e1, e2);
}

void
intlit_unify_ind (intlit e1, intlit e2)
{
  term_unify (intlit_con_match, intlit_occurs, e1, e2);
}

void
intlit_print (FILE *arg1, intlit arg2)
{
  gen_e ecr = term_get_ecr (arg2);
...
bool
intlit_occurs (term_var arg1, intlit arg2)
{
  gen_e ecr = term_get_ecr (arg2);
...
void
intlit_con_match (gen_e arg1, gen_e arg2)
{
  switch (((gen_term)arg1)->type)
    {
    default:
...
stamp
intbound_get_stamp (gen_e arg1)
{
  return term_get_stamp ((gen_e)arg1);
}

bool
intbound_is_var (gen_e arg1)
{
  return term_is_var ((gen_e)arg1);
}
...
intbound
intbound_fresh (const char *name)
{
  return term_fresh (name);
}

intbound
intbound_fresh_small (const char *name)
{
  return term_fresh_small (name);
}

intbound
intbound_fresh_large (const char *name)
{
  return term_fresh_large (name);
}

intbound
intbound_constant (const char *name)
{
  return term_constant (name);
}

bool
intbound_is_constant (intbound e, const char *name)
{
  if (term_is_constant (e))
    return !strcmp (name, term_get_constant_name (e));
  else
...
intbound
intbound_ecr (intbound e)
{
  return term_get_ecr (e);
}

void
intbound_inclusion_ind (intbound e1, intbound e2)
{
  term_unify (intbound_con_match, intbound_occurs, e1, e2);
}

bool
intbound_eq (intbound e1, intbound e2)
{
  return term_eq (e1, e2);
}

int
intbound_cmp (const intbound e1, const intbound e2)
{
  return term_get_stamp (e1) - term_get_stamp (e2);
}

void
intbound_inclusion_ind_contra (intbound e1, intbound e2)
{
  term_unify (intbound_con_match, intbound_occurs, e2, e1);
}

void
intbound_unify (intbound e1, intbound e2)
{
  banshee_clock_tick ();
...
void
intbound_cunify (intbound e1, intbound e2)
{
  banshee_clock_tick ();
...
void
intbound_cunify_ind (intbound e1, intbound e2)
{
  term_cunify (intbound_con_match, intbound_occurs, e1, e2);
}

void
intbound_unify_ind (intbound e1, intbound e2)
{
  term_unify (intbound_con_match, intbound_occurs, e1, e2);
}

bool
intbound_is_eq (intbound e)
{
...
void
intbound_print (FILE *arg1, intbound arg2)
{
  gen_e ecr = term_get_ecr (arg2);
...
bool
intbound_occurs (term_var arg1, intbound arg2)
{
  gen_e ecr = term_get_ecr (arg2);
...
void
intbound_con_match (gen_e arg1, gen_e arg2)
{
  switch (((gen_term)arg1)->type)
    {
    case EQ_:
...
void
cycinf_stats (FILE *arg1)
{
  engine_stats (arg1);
}

void
cycinf_print_graph (FILE *arg1)
{
