...
int Cyc__IO_vfprintf(int (* ioputc)(int,void *),void * ioputc_env,struct _fat_ptr fmt0,
  ...
  { int softsign = 0;
    ...
    int size = 0;
    char buf[349U];
    { unsigned int _T130 = 348U;
      unsigned int i;
      i = 0;
      _TL38: if (i < _T130) { goto _TL36;
      }else { goto _TL37;
      }
      _TL36: _T2 = buf;
      _T3 = i;
	...
	{ unsigned int fmt_sz = _get_fat_size(_T7,sizeof(char));
	  ...
	  case 99: 
	    _T48 = buf;
	    cp = _tag_fat(_T48,sizeof(char),349U);
	    { struct _fat_ptr _T130 = cp;
	      _T49 = _T130.curr;
	      _T4A = (char *)_T49;
	      { char _T131 = *_T4A;
		_T4B = Cyc_va_arg_int(ap);
		{ char _T132 = (char)_T4B;
		  _T4C = _get_fat_size(_T130,sizeof(char));
		  if (_T4C != 1U) { goto _TL5F;
		  }
		  if (_T131 != 0) { goto _TL5F;
		  }
		  if (_T132 == 0) { goto _TL5F;
		  }
		  _throw_arraybounds();
		  goto _TL60;
		  _TL5F: _TL60: _T4D = _T130.curr;
		  _T4E = (char *)_T4D;
		  *_T4E = _T132;
		}
	      }
	    }_T4F = &ap;
	    _fat_ptr_inplace_plus(_T4F,sizeof(void *),1);
	    size = 1;
	    sign = '\000';
	    goto _LL0;
	  case 68: 
	  ...
	  case 105: 
	    ...
	    _T50 = Cyc_va_arg_long(ap);
	    goto _TL62;
	    _TL61: if (! (flags & 4)) { goto _TL63;
	    }
	    _T52 = Cyc_va_arg_int(ap);
	    _T53 = (short)_T52;
	    _T51 = (long)_T53;
	    goto _TL64;
	    _TL63: _T51 = Cyc_va_arg_int(ap);
	    _TL64: _T50 = _T51;
	    _TL62: _ulong = (unsigned long)_T50;
	    _T54 = &ap;
	    _fat_ptr_inplace_plus(_T54,sizeof(void *),1);
	    _T55 = _ulong;
	    _T56 = (long)_T55;
	  ...
	  case 71: 
	    ...
	    _T57 = &ap;
	    _fat_ptr_inplace_plus(_T57,sizeof(void *),1);
	    ...
	    _TL67: _T58 = prec;
	    _T59 = - 1;
	    if (_T58 != _T59) { goto _TL6E;
	    }
	    prec = 6;
	    goto _TL6F;
	    _TL6E: _TL6F: _TL68: _T5A = buf;
	    cp = _tag_fat(_T5A,sizeof(char),349U);
	    { struct _fat_ptr _T130 = cp;
	      _T5B = _T130.curr;
	      _T5C = (char *)_T5B;
	      { char _T131 = *_T5C;
		char _T132 = '\000';
		_T5D = _get_fat_size(_T130,sizeof(char));
		if (_T5D != 1U) { goto _TL70;
		}
		...
		*_T5F = _T132;
	    ...
	    _T65 = cp;
	    _T66 = buf;
	    _T67 = _tag_fat(_T66,sizeof(char),349U);
	    _T68 = sizeof(buf);
	    _T69 = _T68 - 1U;
	    _T6A = (int)_T69;
	    _T6B = _fat_ptr_plus(_T67,sizeof(char),_T6A);
	    size = Cyc___cvt_double(_T60,_T61,_T62,_T63,_T64,_T65,_T6B);
	    _T6C = softsign;
	    if (! _T6C) { goto _TL72;
	    }
	    sign = '-';
	    ...
	    _T70 = *_T6F;
	    _T71 = (int)_T70;
	    if (_T71 != 0) { goto _TL74;
	    }
	    _T72 = &cp;
	    _fat_ptr_inplace_plus(_T72,sizeof(char),1);
	    goto _TL75;
	    _TL74: _TL75: goto _LL0;
	  case 110: 
	    if (! (flags & 1)) { goto _TL76;
	    }
	    _T73 = Cyc_va_arg_int_ptr(ap);
	    _T74 = ret;
	    *_T73 = (unsigned long)_T74;
	    goto _TL77;
	    _TL76: if (! (flags & 4)) { goto _TL78;
	    }
	    _T75 = Cyc_va_arg_short_ptr(ap);
	    _T76 = ret;
	    *_T75 = (short)_T76;
	    goto _TL79;
	    _TL78: _T77 = Cyc_va_arg_int_ptr(ap);
	    _T78 = ret;
	    *_T77 = (unsigned long)_T78;
	    _TL79: _TL77: _T79 = &ap;
	    _fat_ptr_inplace_plus(_T79,sizeof(void *),1);
	    goto _TL39;
	  case 79: 
	    flags = flags | 1;
	    goto _LL40;
	  case 111: 
	    ...
	    _T7A = Cyc_va_arg_ulong(ap);
	    goto _TL7B;
	    _TL7A: if (! (flags & 4)) { goto _TL7C;
	    }
	    _T7C = Cyc_va_arg_int(ap);
	    _T7D = (unsigned short)_T7C;
	    _T7B = (unsigned long)_T7D;
	    goto _TL7D;
	    _TL7C: _T7B = Cyc_va_arg_uint(ap);
	    _TL7D: _T7A = _T7B;
	    _TL7B: _ulong = _T7A;
	    _T7E = &ap;
	    _fat_ptr_inplace_plus(_T7E,sizeof(void *),1);
	    base = 0U;
	    goto nosign;
	  case 112: 
	    _T7F = Cyc_va_arg_long(ap);
	    _ulong = (unsigned long)_T7F;
	    _T80 = &ap;
	    _fat_ptr_inplace_plus(_T80,sizeof(void *),1);
	    base = 2U;
	    flags = flags | 64;
	    ch = 120;
	    goto nosign;
	  ...
	  case 117: 
	    ...
	    _T8B = Cyc_va_arg_ulong(ap);
	    goto _TL85;
	    _TL84: if (! (flags & 4)) { goto _TL86;
	    }
	    _T8D = Cyc_va_arg_int(ap);
	    _T8E = (unsigned short)_T8D;
	    _T8C = (unsigned long)_T8E;
	    goto _TL87;
	    _TL86: _T8C = Cyc_va_arg_uint(ap);
	    _TL87: _T8B = _T8C;
	    _TL85: _ulong = _T8B;
	    _T8F = &ap;
	    _fat_ptr_inplace_plus(_T8F,sizeof(void *),1);
	    base = 1U;
	    goto nosign;
	  case 88: 
	    goto _LL4C;
	  case 120: 
	    ...
	    _T90 = Cyc_va_arg_ulong(ap);
	    goto _TL89;
	    _TL88: if (! (flags & 4)) { goto _TL8A;
	    }
	    _T92 = Cyc_va_arg_int(ap);
	    _T93 = (unsigned short)_T92;
	    _T91 = (unsigned long)_T93;
	    goto _TL8B;
	    _TL8A: _T91 = Cyc_va_arg_uint(ap);
	    _TL8B: _T90 = _T91;
	    _TL89: _ulong = _T90;
	    _T94 = &ap;
	    _fat_ptr_inplace_plus(_T94,sizeof(void *),1);
	    base = 2U;
	    ...
	    number: dprec = prec;
	    _T95 = dprec;
	    if (_T95 < 0) { goto _TL8E;
	    }
	    _T96 = ~ 32;
	    flags = flags & _T96;
	    goto _TL8F;
	    _TL8E: _TL8F: _T97 = buf;
	    _T98 = _tag_fat(_T97,sizeof(char),349U);
	    _T99 = 308 + 39;
	    _T9A = _T99 + 1;
	    cp = _fat_ptr_plus(_T98,sizeof(char),_T9A);
	    ...
	    _TL92: { struct _fat_ptr xdigs;
	      ...
	      case Cyc_OCT: 
		_TL95: _T9D = &cp;
		{ struct _fat_ptr _T130 = _fat_ptr_inplace_plus(_T9D,sizeof(char),
								-1);
		  _T9E = _check_fat_subscript(_T130,sizeof(char),0U);
		  _T9F = (char *)_T9E;
		  { char _T131 = *_T9F;
		    _TA0 = _ulong & 7U;
		    _TA1 = _TA0 + 48U;
		    { char _T132 = (char)_TA1;
		      _TA2 = _get_fat_size(_T130,sizeof(char));
		      if (_TA2 != 1U) { goto _TL97;
		      }
		      if (_T131 != 0) { goto _TL97;
		      }
		      if (_T132 == 0) { goto _TL97;
		      }
		      _throw_arraybounds();
		      goto _TL98;
		      _TL97: _TL98: _TA3 = _T130.curr;
		      _TA4 = (char *)_TA3;
		      *_TA4 = _T132;
		    }
		  }
		...
		_TA7 = cp;
		_TA8 = _check_fat_subscript(_TA7,sizeof(char),0U);
		_TA9 = (char *)_TA8;
		_TAA = *_TA9;
		_TAB = (int)_TAA;
		if (_TAB == 48) { goto _TL99;
		}
		_TAC = &cp;
		{ struct _fat_ptr _T130 = _fat_ptr_inplace_plus(_TAC,sizeof(char),
								-1);
		  _TAD = _check_fat_subscript(_T130,sizeof(char),0U);
		  _TAE = (char *)_TAD;
		  { char _T131 = *_TAE;
		    char _T132 = '0';
		    _TAF = _get_fat_size(_T130,sizeof(char));
		    if (_TAF != 1U) { goto _TL9B;
		    }
		    if (_T131 != 0) { goto _TL9B;
		    }
		    if (_T132 == 0) { goto _TL9B;
		    }
		    _throw_arraybounds();
		    goto _TL9C;
		    _TL9B: _TL9C: _TB0 = _T130.curr;
		    _TB1 = (char *)_TB0;
		    *_TB1 = _T132;
		  }
		}goto _TL9A;
		...
		_TL9E: _TB2 = &cp;
		{ struct _fat_ptr _T130 = _fat_ptr_inplace_plus(_TB2,sizeof(char),
								-1);
		  _TB3 = _check_fat_subscript(_T130,sizeof(char),0U);
		  _TB4 = (char *)_TB3;
		  { char _T131 = *_TB4;
		    _TB5 = _ulong % 10U;
		    _TB6 = _TB5 + 48U;
		    { char _T132 = (char)_TB6;
		      _TB7 = _get_fat_size(_T130,sizeof(char));
		      if (_TB7 != 1U) { goto _TLA0;
		      }
		      if (_T131 != 0) { goto _TLA0;
		      }
		      if (_T132 == 0) { goto _TLA0;
		      }
		      _throw_arraybounds();
		      goto _TLA1;
		      _TLA0: _TLA1: _TB8 = _T130.curr;
		      _TB9 = (char *)_TB8;
		      *_TB9 = _T132;
		    }
		  }
		...
		goto _TL9D;
		_TL9F: _TBA = &cp;
		{ struct _fat_ptr _T130 = _fat_ptr_inplace_plus(_TBA,sizeof(char),
								-1);
		  _TBB = _check_fat_subscript(_T130,sizeof(char),0U);
		  _TBC = (char *)_TBB;
		  { char _T131 = *_TBC;
		    _TBD = _ulong + 48U;
		    { char _T132 = (char)_TBD;
		      _TBE = _get_fat_size(_T130,sizeof(char));
		      if (_TBE != 1U) { goto _TLA2;
		      }
		      if (_T131 != 0) { goto _TLA2;
		      }
		      if (_T132 == 0) { goto _TLA2;
		      }
		      _throw_arraybounds();
		      goto _TLA3;
		      _TLA2: _TLA3: _TBF = _T130.curr;
		      _TC0 = (char *)_TBF;
		      *_TC0 = _T132;
		    }
		  }
		...
		_TLA5: _TLA6: _TC1 = &cp;
		{ struct _fat_ptr _T130 = _fat_ptr_inplace_plus(_TC1,sizeof(char),
								-1);
		  _TC2 = _check_fat_subscript(_T130,sizeof(char),0U);
		  _TC3 = (char *)_TC2;
		  { char _T131 = *_TC3;
		    _TC4 = xdigs;
		    _TC5 = _ulong & 15U;
		    _TC6 = (int)_TC5;
		    _TC7 = _check_fat_subscript(_TC4,sizeof(char),_TC6);
		    _TC8 = (const char *)_TC7;
		    { char _T132 = *_TC8;
		      _TC9 = _get_fat_size(_T130,sizeof(char));
		      if (_TC9 != 1U) { goto _TLA8;
		      }
		      if (_T131 != 0) { goto _TLA8;
		      }
		      if (_T132 == 0) { goto _TLA8;
		      }
		      _throw_arraybounds();
		      goto _TLA9;
		      _TLA8: _TLA9: _TCA = _T130.curr;
		      _TCB = (char *)_TCA;
		      *_TCB = _T132;
		    }
		  }
		...
		_TLA7: goto _LL4F;
	      default: 
		_TCE = _tag_fat("bug in vform: bad base",sizeof(char),23U);
		cp = Cyc_strdup(_TCE);
		goto skipsize;
	      }
	      _LL4F: ;
	    }goto _TL91;
	    _TL90: _TL91: _TCF = buf;
	    _TD0 = _tag_fat(_TCF,sizeof(char),349U);
	    _TD1 = 308 + 39;
	    _TD2 = _TD1 + 1;
	    _TD3 = _fat_ptr_plus(_TD0,sizeof(char),_TD2);
	    _TD4 = _TD3.curr;
	    _TD5 = cp;
	    _TD6 = _TD5.curr;
	    _TD7 = _TD4 - _TD6;
	    size = _TD7 / sizeof(char);
	    skipsize: goto _LL0;
	  default: 
	    if (ch != 0) { goto _TLAA;
	    }
	    goto done;
	    _TLAA: _TD8 = buf;
	    cp = _tag_fat(_TD8,sizeof(char),349U);
	    { struct _fat_ptr _T130 = cp;
	      _TD9 = _T130.curr;
	      _TDA = (char *)_TD9;
	      { char _T131 = *_TDA;
		_TDB = ch;
		{ char _T132 = (char)_TDB;
		  _TDC = _get_fat_size(_T130,sizeof(char));
		  if (_TDC != 1U) { goto _TLAC;
		  }
		  if (_T131 != 0) { goto _TLAC;
		  }
		  if (_T132 == 0) { goto _TLAC;
		  }
		  _throw_arraybounds();
		  goto _TLAD;
		  _TLAC: _TLAD: _TDD = _T130.curr;
		  _TDE = (char *)_TDD;
		  *_TDE = _T132;
		}
	      }
	  ...
	  fieldsz = fieldsz + 2;
	  goto _TLB3;
	  _TLB2: _TLB3: _TLB1: _TE1 = dpad;
	  fieldsz = fieldsz + _TE1;
	  _TE2 = flags;
	  _TE3 = 16 | 32;
	  _TE4 = _TE2 & _TE3;
	  if (_TE4 != 0) { goto _TLB4;
	  }
	  _TE5 = ioputc;
	  _TE6 = ioputc_env;
	  _TE7 = width - fieldsz;
	  _TE8 = Cyc__IO_padn(_TE5,_TE6,' ',_TE7);
	  _TE9 = width - fieldsz;
	  if (_TE8 >= _TE9) { goto _TLB6;
	  }
	  goto error;
	  _TLB6: goto _TLB5;
	  _TLB4: _TLB5: _TEA = sign;
	  _TEB = (int)_TEA;
	  if (! _TEB) { goto _TLB8;
	  }
	  _TEC = sign_string;
	  _TED = _tag_fat(_TEC,sizeof(char),2U);
	  { struct _fat_ptr _T130 = _fat_ptr_plus(_TED,sizeof(char),0);
	    _TEE = _check_fat_subscript(_T130,sizeof(char),0U);
	    _TEF = (char *)_TEE;
	    { char _T131 = *_TEF;
	      char _T132 = sign;
	      _TF0 = _get_fat_size(_T130,sizeof(char));
	      if (_TF0 != 1U) { goto _TLBA;
	      }
	      if (_T131 != 0) { goto _TLBA;
	      }
	      if (_T132 == 0) { goto _TLBA;
	      }
	      _throw_arraybounds();
	      goto _TLBB;
	      _TLBA: _TLBB: _TF1 = _T130.curr;
	      _TF2 = (char *)_TF1;
	      *_TF2 = _T132;
	    }
	  }_TLBC: _TF3 = ioputc;
	  _TF4 = ioputc_env;
	  _TF5 = sign_string;
	  _TF6 = _tag_fat(_TF5,sizeof(char),2U);
	  _TF7 = _TF6;
	  _TF8 = Cyc__IO_sputn(_TF3,_TF4,_TF7,1);
	  if (_TF8 == 1) { goto _TLBE;
	  }
	  goto error;
	  ...
	  _TFD = ioputc_env;
	  _TFE = ox;
	  _TFF = _tag_fat(_TFE,sizeof(char),2U);
	  _T100 = Cyc__IO_nzsputn(_TFC,_TFD,_TFF,2);
	  if (_T100 == 2) { goto _TLC4;
	  }
	  goto error;
	  ...
	  _TLC3: goto _TLC1;
	  _TLC0: _TLC1: _TLB9: _T101 = flags;
	  _T102 = 16 | 32;
	  _T103 = _T101 & _T102;
	  if (_T103 != 32) { goto _TLC6;
	  }
	  _T104 = ioputc;
	  _T105 = ioputc_env;
	  _T106 = width - fieldsz;
	  _T107 = Cyc__IO_padn(_T104,_T105,'0',_T106);
	  _T108 = width - fieldsz;
	  if (_T107 >= _T108) { goto _TLC8;
	  }
	  goto error;
	  _TLC8: goto _TLC7;
	  _TLC6: _TLC7: _T109 = ioputc;
	  _T10A = ioputc_env;
	  _T10B = dpad;
	  _T10C = Cyc__IO_padn(_T109,_T10A,'0',_T10B);
	  _T10D = dpad;
	  if (_T10C >= _T10D) { goto _TLCA;
	  }
	  goto error;
	  ...
	  _T111 = _T110;
	  _T112 = size;
	  _T113 = Cyc__IO_sputn(_T10E,_T10F,_T111,_T112);
	  _T114 = size;
	  if (_T113 == _T114) { goto _TLD0;
	  }
	  goto error;
	  ...
	  _T11F = _T11E;
	  _T120 = size;
	  _T121 = Cyc__IO_nzsputn(_T11C,_T11D,_T11F,_T120);
	  _T122 = size;
	  if (_T121 == _T122) { goto _TLDC;
	  }
	  goto error;
	  ...
	  _TLDB: goto _TLD9;
	  _TLD8: _TLD9: _TLD3: _TLCD: _T123 = ioputc;
	  _T124 = ioputc_env;
	  _T125 = fpprec;
	  _T126 = Cyc__IO_padn(_T123,_T124,'0',_T125);
	  _T127 = fpprec;
	  if (_T126 >= _T127) { goto _TLDE;
	  }
	  goto error;
	  ...
	  _T129 = ioputc_env;
	  _T12A = width - fieldsz;
	  _T12B = Cyc__IO_padn(_T128,_T129,' ',_T12A);
	  _T12C = width - fieldsz;
	  if (_T12B >= _T12C) { goto _TLE2;
	  }
	  goto error;
	  _TLE2: goto _TLE1;
