	...
	*_TA7 = (unsigned char)_TA8;
	{ int borrow;
	  ...
	  { int (* _TD2)(struct _fat_ptr,struct _fat_ptr,unsigned int) = (int (*)(struct _fat_ptr,
										  ...
										  unsigned int))_TAC;
	    _TAB = _TD2;
	  }_TAD = _tag_fat("0 <= k && k <= k + m",sizeof(char),21U);
	  _TAE = _tag_fat("cyclone/library/std/xp.cyc",sizeof(char),27U);
	  _TAB(_TAD,_TAE,151U);
	  _TL53: _TAF = m + 1;
	  _TB0 = rem;
	  _TB1 = k;
	  ...
	  _TBA = _tag_fat("cyclone/library/std/xp.cyc",sizeof(char),27U);
	  _TB7(_TB9,_TBA,153U);
	  _TL55: ;
	}
      }k = k + -1;
