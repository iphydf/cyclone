...
extern int pthread_cycfun_wrap(struct _tuple6 *);
...
int Cyc_pthread_create(unsigned long * thread,const union Cyc_pthread_attr_t * attr,
  ...
  int (* _T0)(unsigned long *,const union Cyc_pthread_attr_t *,int (*)(struct _tuple6 *),
	      struct _tuple6 *);
  int (* _T1)(unsigned long *,const union Cyc_pthread_attr_t *,void * (*)(void *),
	      void *);
  unsigned long * _T2;
  const union Cyc_pthread_attr_t * _T3;
  int (* _T4)(struct _tuple6 *);
  struct _tuple6 * _T5;
  int _T6;
  _T1 = pthread_create;
  { int (* _T7)(unsigned long *,const union Cyc_pthread_attr_t *,int (*)(struct _tuple6 *),
		struct _tuple6 *) = (int (*)(unsigned long *,const union Cyc_pthread_attr_t *,
					     int (*)(struct _tuple6 *),struct _tuple6 *))_T1;
    _T0 = _T7;
  }_T2 = thread;
  _T3 = attr;
  _T4 = pthread_cycfun_wrap;
  { struct _tuple6 * _T7 = _cycalloc(sizeof(struct _tuple6));
    _T7->f0 = cycfun;
    _T7->f1 = arg;
    _T5 = (struct _tuple6 *)_T7;
 ...
 union _tuple13 {
  struct _tuple12 _addr_bnd;
  unsigned int _pkey;
};
 struct _tuple14 {
  void * si_addr;
  short si_addr_lsb;
  union _tuple13 _bounds;
};
 struct _tuple15 {
  long si_band;
  int si_fd;
 ...
 union _tuple17 {
  ...
  struct _tuple8 _kill;
  struct _tuple9 _timer;
  struct _tuple10 _rt;
  struct _tuple11 _sigchld;
  struct _tuple14 _sigfault;
  struct _tuple15 _sigpoll;
  struct _tuple16 _sigsys;
};
 struct _tuple18 {
  int si_signo;
  int si_errno;
  int si_code;
  int __pad0;
  union _tuple17 _sifields;
};
 union _tuple19 {
  void (* sa_handler)(int);
  void (* sa_sigaction)(int,struct _tuple18 *,void *);
};
 struct Cyc_sigaction {
  union _tuple19 __sigaction_handler;
  struct _tuple7 sa_mask;
  int sa_flags;
  void (* sa_restorer)();
};
...
int  __attribute__((cdecl))Cyc_sigaction(int sig,const struct Cyc_sigaction * act,
 ...
 struct _tuple23 {
  int __count;
  union _tuple22 __value;
};
 struct Cyc__G_fpos_t {
  long __pos;
  struct _tuple23 __state;
};
...
extern int pselect(int,struct _tuple26 *,struct _tuple26 *,struct _tuple26 *,
		   const struct Cyc_timespec *,const struct _tuple7 *);
extern int * __CYCLONE_ERRNO();
extern int Cyc_pselect(int a,struct _tuple26 * b,struct _tuple26 * c,struct _tuple26 * d,
		       const struct Cyc_timespec * e,const struct _tuple7 * f) {
  int * _T0;
  int * _T1;
  int _T2;
  int _T3;
...
extern int select(int,struct _tuple26 *,struct _tuple26 *,struct _tuple26 *,
		  struct Cyc_timeval *);
extern int Cyc_select(int a,struct _tuple26 * b,struct _tuple26 * c,struct _tuple26 * d,
...
extern void __stub_FD_CLR(int,struct _tuple26 *);
extern int __stub_FD_ISSET(int,struct _tuple26 *);
extern void __stub_FD_SET(int,struct _tuple26 *);
extern void __stub_FD_ZERO(struct _tuple26 *);
void Cyc_FD_CLR(int a,struct _tuple26 * b) {
  if (a < 0) { goto _TL63;
  }else { goto _TL64;
  }
...
int Cyc_FD_ISSET(int a,struct _tuple26 * b) {
  int _T0;
  if (a < 0) { goto _TL67;
  }else { goto _TL68;
  }
...
void Cyc_FD_SET(int a,struct _tuple26 * b) {
  if (a < 0) { goto _TL6B;
  }else { goto _TL6C;
  }
...
void Cyc_FD_ZERO(struct _tuple26 * a) {
  __stub_FD_ZERO(a);
...
int Cyc_accept(int fd,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL6E;
  _TL6D: _TL6E: { struct _tuple28 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_bind(int fd,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL74;
  _TL73: _TL74: { struct _tuple28 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_connect(int fd,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL7A;
  _TL79: _TL7A: { struct _tuple28 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_getpeername(int fd,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL80;
  _TL7F: _TL80: { struct _tuple28 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_getsockname(int fd,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL86;
  _TL85: _TL86: { struct _tuple28 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_getsockopt(int fd,int level,int optname,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL8C;
  _TL8B: _TL8C: { struct _tuple28 _T2F;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
long Cyc_recvfrom(int fd,struct _fat_ptr buf,unsigned long n,int flags,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL91;
  _TL90: _TL91: { struct _tuple28 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
long Cyc_sendto(int fd,struct _fat_ptr buf,unsigned long n,int flags,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL97;
  _TL96: _TL97: { struct _tuple28 _T17;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
...
int Cyc_setsockopt(int fd,int level,int optname,struct _fat_ptr ap) {
  ...
  _throw(_T3);
  goto _TL9D;
  _TL9C: _TL9D: { struct _tuple28 _T23;
    _T5 = ap;
    _T6 = _T5.curr;
    _T7 = (void * *)_T6;
    _T8 = _check_null(_T7);
