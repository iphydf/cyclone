...
void printf_test() {
  ...
  eqstrings("-2147483648",aprintf("%d",0x80000000));
  eqstrings("2147483648",aprintf("%u",0x80000000));
  eqstrings("80000000",aprintf("%x",0x80000000));
  eqstrings("9223372036854775807",aprintf("%llu",0x7fffffffffffffffll));
  eqstrings("7fffffffffffffff",aprintf("%llx",0x7fffffffffffffffll));
  // eqstrings("-9223372036854775808",aprintf("%lld",0x8000000000000000ll));
  // eqstrings("9223372036854775808",aprintf("%llu",0x8000000000000000ull));
  // eqstrings("8000000000000000",aprintf("%llx",0x8000000000000000ull));
}
